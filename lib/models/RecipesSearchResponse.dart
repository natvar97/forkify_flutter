...
class RecipesSearchResponse {
  ...
  RecipesSearchResponse.fromJson(dynamic json) {
    _count = json['count'];
...
class Recipes {
  ...
  double? get socialRank => _socialRank;
